...
import com.abewy.android.apps.openklyph.core.fql.serializer.FriendSerializer;
	...
	private ServiceConnection	mSecondConnection	= new ServiceConnection() {
														public void onServiceConnected(ComponentName className, IBinder service)
														{
															...
															catch (RemoteException e)
															{
																...
																CrashReporter.log(Log.DEBUG, "SelectionFragment", "Can't connect to service " + e.getMessage());
															}
