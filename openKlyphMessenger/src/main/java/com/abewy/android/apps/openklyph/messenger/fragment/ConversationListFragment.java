...
import com.abewy.android.apps.openklyph.core.fql.serializer.MessageThreadDeserializer;
import com.abewy.android.apps.openklyph.core.fql.serializer.MessageThreadSerializer;
...
import com.abewy.android.apps.openklyph.messenger.adapter.MultiObjectAdapter;
import com.abewy.android.apps.openklyph.messenger.request.AsyncRequest;
import com.abewy.android.apps.openklyph.messenger.request.AsyncRequest.Query;
import com.abewy.android.apps.openklyph.messenger.service.IMessengerCallback;
import com.abewy.android.apps.openklyph.messenger.service.IMessengerService;
...
public class ConversationListFragment extends KlyphFragment
{
	...
	private ServiceConnection	mConnection			= new ServiceConnection() {
														public void onServiceConnected(ComponentName className, IBinder service)
														{
															...
															{
																CrashReporter.log(Log.DEBUG, "ConversationListFragment", "Can't connect to service "
                                                                        + e.getMessage());
