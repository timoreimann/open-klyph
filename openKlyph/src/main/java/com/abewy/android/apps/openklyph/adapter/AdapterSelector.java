...
import com.abewy.android.apps.openklyph.adapter.fql.AlbumAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.BirthdayAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.CommentAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.EducationAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.ElementTimelineAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.EventAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.EventAdapter2;
import com.abewy.android.apps.openklyph.adapter.fql.EventAttendeesAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.EventDataAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.EventResponseAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.FriendAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.FriendListAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.FriendPickerAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.FriendPickerSingleAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.FriendRequestAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.GroupAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.GroupTimelineAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.MemberAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.MessageAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.MessageSessionUserAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.NotificationAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.PageAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.PhotoAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.PhotoListAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.RelativeAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.StreamAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.StreamAdapter2;
import com.abewy.android.apps.openklyph.adapter.fql.StreamLikeAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.TagAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.ThreadAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.VideoAdapter;
import com.abewy.android.apps.openklyph.adapter.fql.WorkAdapter;
import com.abewy.android.apps.openklyph.adapter.items.FakeHeaderItemAdapter;
...
public class AdapterSelector
{
	...
	static TypeAdapter<GraphObject> getAdapter(GraphObject object, int layoutType, MultiObjectAdapter parentAdapter)
	{
		...
		switch (getItemViewType(object))
		{
			...
			{
				return new com.abewy.android.apps.openklyph.adapter.graph.CommentAdapter();
			}
