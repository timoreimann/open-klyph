...
import com.abewy.android.apps.openklyph.KlyphDownloadManager;
...
import com.abewy.android.apps.openklyph.facebook.IFbPermissionWorker;
import com.abewy.android.apps.openklyph.fragment.StreamFragment.StreamLikeCount;
...
import com.abewy.android.apps.openklyph.view.ListEmptyView;
import com.abewy.android.apps.openklyph.widget.KlyphSlidingDrawer;
...
public class ImageFragment extends KlyphFragment implements IFbPermissionCallback
{
	...
	{
		com.abewy.android.apps.openklyph.core.graph.Comment.Attachment.Media.Image image = comment.getAttachment().getMedia().getImage();
